...
<body class="is-theme-green">
    ...
    <nav class="navbar navbar-landing nav-light is-transparent is-fixed-top is-faded">
        <div class="container">
            ...
            <div class="navbar-menu">
                <div class="navbar-start">
                    <a href="#main-features" class="navbar-item has-hover scroll-link">
                        Features
                    </a>

                    <a href="#pricing" class="navbar-item has-hover scroll-link">
                        Pricing
                    </a>
                    <a href="https://community.singlebag.com" class="navbar-item has-hover scroll-link">
                        Community
                    </a>
                    <a href="https://community.singlebag.com/lp-courses" class="navbar-item has-hover scroll-link">
                        Academy
                    </a>
                    <a href="https://singlebag.com/partner/" class="navbar-item has-hover scroll-link">
                        Partner program
                    </a>
                ...
                <div class="navbar-end has-hover">
                    <a href="{{ url(env('APP_URL') . '/verify-store') }}" class="navbar-item has-hover scroll-link">
                        Login
                    </a>
                    <div class="navbar-item">
                        <a href="{{ route('seller.signup') }}" class="button button-signup is-bold  primary-btn">Create Store</a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <footer class="footer-light-medium">
        <div class="container">
            ...
            <div class="footer-copyright has-text-centered">
                <p>
                    &copy; {{ date("Y") }} | <a href="{{ url('/') }}">{{ env('APP_NAME') }}</a> | All
                    Rights Reserved.
                </p>
            </div>
        </div>
