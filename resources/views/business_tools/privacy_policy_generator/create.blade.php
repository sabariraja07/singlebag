        ...
        <div class="breadcrumb-area bg-light">
            <div class="container-fluid">
                <div class="breadcrumb-content text-center">
                    <h1 class="title">{{ __('Privacy Policy Generator') }}</h1>
                    <ul>
                        <li>
                            <a href="/">{{ __('Home') }}</a>
                        </li>
                        <li class="active">{{ __('Privacy Policy Generator') }}</li>
                    </ul>
                </div>
            </div>
        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <hr>
                                <div class="card-body">
                                    <form id="basicform" action="{{ route('privacy-policy-generator.store') }}" method="post">
                                        @csrf
