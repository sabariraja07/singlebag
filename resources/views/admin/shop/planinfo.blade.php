  ...
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="basicform" action="{{ route('admin.shop.updateplaninfo',$info->id) }}" method="post">
          @csrf
          @method('PUT')
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="product_limit"   value="{{ $planinfo->product_limit ?? -1 }}">
            </div>
          </div>

          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Storage Limit') }} (1024 MB = 1 GB )</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="storage"   value="{{ $planinfo->storage ?? -1 }}">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Customer Limit') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="customer_limit"   value="{{ $planinfo->customer_limit ?? -1}}">
            </div>
          </div>

          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Delivery Agent Limit') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="agent_limit" required   value="{{ $planinfo->agent_limit ?? -1}}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="category_limit"   value="{{ $planinfo->category_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="location_limit"   value="{{ $planinfo->location_limit ?? -1 }}">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Brand Limit') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="brand_limit"   value="{{ $planinfo->brand_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" name="variation_limit"   value="{{ $planinfo->variation_limit ?? -1 }}">
            </div>
          </div>
