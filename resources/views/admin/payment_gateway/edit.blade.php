...
<div class="row">
  <div class="col-12 mt-2">
    <div class="card">
      <div class="card-body">
        <form method="post" action="{{ route('admin.payment-gateway.update',$info->id) }}" class="basicform" enctype="multipart/form-data">
          @csrf
          @method('PUT')
          <div class="row">
            <div class="col-sm-8">
             ...
             <div class="form-group">
              ...
              <input type="text" name="gateway" class="form-control" required value="{{ $info->slug }}"> 
            </div>
            ...
            <div class="form-group">
             <button class="btn btn-success basicbtn" type="submit" >Update</button>
             </div>
           </div>
            <div class="col-sm-4">
