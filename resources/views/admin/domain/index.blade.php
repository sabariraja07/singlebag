      ...
      <div class="card-body">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-4 text-right">
            @can('domain.create')
            <a href="{{ route('admin.domain.create') }}" class="btn btn-success">{{ __('Create Domain') }}</a>
            @endcan
          </div>
        </div>
        ...
        <form method="post" action="{{ route('admin.domains.destroy') }}" class="basicform_with_reload">
          @csrf
            ...
            <table class="table table-striped table-hover text-center table-borderless">
              ...
              <tbody>
                ...
                <tr id="row{{ $row->id }}">
                  ...
                  <td><a href="{{ route('admin.shop.show',$row->shop->id) }}">{{ $row->shop->name }}</a></td>
                  <td>
                  ...
                  <td>
                    @can('domain.edit')
                    <a href="{{ route('admin.domain.edit',$row->id) }}" class="btn btn-info btn-sm text-center"><i class="far fa-edit"></i></a>
                    @endcan
