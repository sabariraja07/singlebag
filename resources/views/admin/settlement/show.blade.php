                ...
                <div class="card profile-widget">
                    ...
                    <div class="card-footer">
                        <div class="text-right">
                            <form method="POST" action="{{ route('admin.settlement.update',$info->id) }}" accept-charset="UTF-8" class="d-inline">
                                @csrf
                                @method('PUT')
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-hover text-center table-borderless">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        <td>
                                            <a href="{{ route('admin.order.show',$row->id) }}">{{ $row->order_no }}</a>
                                        </td>
                                        <td>{{ $row->plan->name }}</td>
                                        ...
                                        <td><a href="{{ route('admin.order.show',$row->id) }}" class="btn btn-success btn-sm"><i class="fa fa-eye"></i></a></td>
                                    </tr>
                                    @endforeach
                                </tbody>
                            </table>
