...
<section class="section">
      ...
      <div class="card card-statistic-2">
        <div class="card-stats">
          <div class="card-stats-title">{{ __('Order Statistics') }} -
            <div class="dropdown d-inline">
              ...
              <ul class="dropdown-menu dropdown-menu-sm">
                ...
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='January') active @endif" data-month="January" >{{ __('January') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='February') active @endif" data-month="February" >{{ __('February') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='March') active @endif" data-month="March" >{{ __('March') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='April') active @endif" data-month="April" >{{ __('April') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='May') active @endif" data-month="May" >{{ __('May') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='June') active @endif" data-month="June" >{{ __('June') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='July') active @endif" data-month="July" >{{ __('July') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='August') active @endif" data-month="August" >{{ __('August') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='September') active @endif" data-month="September" >{{ __('September') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='October') active @endif" data-month="October" >{{ __('October') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='November') active @endif" data-month="November" >{{ __('November') }}</a></li>
                <li><a href="javascript:void(0);" class="dropdown-item month @if(Date('F')=='December') active @endif" data-month="December" >{{ __('December') }}</a></li>
              </ul>
            </div>
          </div>
          <div class="card-stats-items">
            ...
            <div class="card-stats-item">
              <div class="card-stats-item-count" id="total_declined"></div>
              <div class="card-stats-item-label">{{ __('Declined') }}</div>
            </div>
          </div>
        </div>
  ...
  <div class="col-lg-4 col-md-12 col-12 col-sm-12">
    <div class="card">
      <div class="card-header">
        <h4>{{ __('Recent Domain Request') }}</h4>
      </div>
    
      @if(count($request_domain_users) != 0)
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-hover table-nowrap card-table text-center">
            ...
            <tbody class="list font-size-base rowlink" data-link="row">
              @foreach($request_domain_users as $row)
              
              <tr>
                
                <td> {{ $row->domain }}</td>
                <td><a href="{{ route('admin.customdomain.show',2) }}">{{ __('View') }}</a></td>
              </tr> 
              @endforeach
            </tbody>
          </table>
      ...
      <div style="padding-left: 31px;font-size: 15px;padding-bottom:10px"><a href="{{ route('admin.customdomain.index') }}">{{ __('View All') }}</a></div>
      @else
      <div class="card-body">
        <div class="table-responsive">
          {{ __('No Record Found') }}
  ...
  <div class="col-md-12 col-12 col-sm-12">
    <div class="card">
      <div class="card-header">
        <h4><a href="{{ route('admin.order.index','status=2') }}">{{ __('Pending Orders') }}</a></h4>
      </div>
      <div class="card-body">
        <div class="table-responsive">
          <table class="table table-hover table-nowrap card-table text-center">
            ...
            <tbody class="list font-size-base rowlink" data-link="row">
              ...
              <tr>
                ...
                <td><a href="{{ route('admin.customer.show',$row->user->id) }}">{{ $row->user->fullname }}</a></td>
