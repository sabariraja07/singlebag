			...
			<div class="card-body">
				...
				<form method="post" action="{{ route('admin.users.update',$user->id) }}" class="basicform">
					...
					<div class="pt-20">
						...
						$arr['title']= 'First Name';
						$arr['id']= 'first_name';
						$arr['type']= 'text';
						$arr['placeholder']= 'Enter First Name';
						$arr['name']= 'first_name';
						$arr['is_required'] = true;
                        $arr['value']=$user->first_name;
						echo  input($arr);

						$arr['title']= 'Last Name';
						$arr['id']= 'last_name';
						$arr['type']= 'text';
						$arr['placeholder']= 'Enter Last Name';
						$arr['name']= 'last_name';
						$arr['is_required'] = true;
                        $arr['value']=$user->last_name;
						echo  input($arr);
				...
				<div class="card">
					<div class="card-body">
						...
						<div class="btn-publish">
							<button type="submit" class="btn btn-success col-12 basicbtn"><i class="fa fa-save"></i> {{ __('Save') }}</button>
						</div>
					</div>
				</div>
			</div>
