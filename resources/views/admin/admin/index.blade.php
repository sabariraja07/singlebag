				...
				<div class="row">
					<div class="col-lg-6">
						<div class="d-flex">
                            ...
                            @can('admin.edit')
							<div class="single-filter">
								<button type="submit" class="btn btn-success btn-lg ml-2 basicbtn">{{ __('Apply') }}</button>
                            </div>
                            @endcan
						</div>
					</div>
					<div class="col-lg-6">
						...
						<div class="add-new-btn">
							<a href="{{ route('admin.users.create') }}" class="btn btn-success float-right">{{ __('Add New Admin') }}</a>
						</div>
						@endcan
					</div>
				</div>
