								...
								<div class="form-group">
									...
									<div class="input-group">
										...
										<div class="input-group-append">
											<button type="button" id="myEditor_icon" class="btn btn-success btn-sm"></button>
										</div>
									</div>
			...
			<div class="card-body">
				<div class="row mb-10">
					...
					<div class="col-sm-3">
							...
							<form id="basicform" class="f-right" method="post" action="{{ route('admin.menus.MenuNodeStore') }}"> @csrf <input type="hidden" name="data" id="data"> <input type="hidden" name="menu_id" value="{{ $info->id }}"> <button id="form-button" class="btn btn-success" type="submit">{{ __('Save Changes') }}</button></form>
