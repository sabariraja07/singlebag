	...
	<div class="card-body">
		...
		<form method="post"  class="basicform" action="{{ route('admin.seo.store') }}">
			...
			<div class="custom-form">
				<div class="row">
					...
					<div class="form-group col-lg-12">
						<button class="btn btn-success col-12 basicbtn" type="submit">{{ __('Update') }}</button>
					</div>
				</div>
			</div>
		</form>
		<form id="basicform" method="post" action="{{ route('admin.seo.update',1) }}">
			...
			<div class="custom-form">
				...
				<div class="form-group">
					<button class="btn btn-success col-12 basicbtn" type="submit">{{ __('Genarate New Sitemap') }}</button>
				</div>
			</div>
		</form>
	</div>
