					...
					<div class="row" style="margin-bottom: 20px;">
						...
						<div class="col">
							<div class="float-right">
								@can('template.upload')
								<a href="#" data-toggle="modal" data-target="#exampleModal" class="btn btn-success">{{ __('Upload Theme') }}</a>
								@endcan
							</div>
						</div>
					</div>
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-success basicbtn">{{ __('Upload') }}</button>
      </div>
      </form>
    </div>
  </div>
