@extends('layouts.app')
@section('head')
    @include('layouts.partials.headersection', ['title' => 'Channel'])
    <style>
        .lt-bg-green-400 {
        --tw-bg-opacity: 1;
            ...
            <div class="card">
                <div class="card-body">
                    <div class="col-sm-12 text-right mb-4">
                        <a href="{{ route('admin.site.channel_create') }}" class="btn btn-success">{{ __('Create Channel
                        ') }}</a>
                      </div>
                                                ...
                                                <div class="dropdown d-inline">
                                                    ...
                                                    <div class="dropdown-menu">
                                                        ...
                                                        <a class="dropdown-item has-icon"
                                                            href="{{ route('admin.site.channel_edit',$channels->id) }}"><i
