					...
					<div class="col-12 col-sm-12 col-md-8">
						...
						<div class="tab-content no-padding" id="myTab2Content">
							<div class="tab-pane fade show active" id="home4" role="tabpanel" aria-labelledby="home-tab4">
                                ...
                                <div class="form-group">
									<label>{{ __('APP_WELCOME_URL') }}</label>
									<input type="text" required="" name="APP_WELCOME_URL" class="form-control" value="{{ env('APP_WELCOME_URL') }}">
								</div>
								<div class="form-group">
							...
							<div class="tab-pane fade" id="mail_configuration" role="tabpanel" aria-labelledby="profile-tab4">
								...
								<br><a href="/store_test_mail" class="btn btn-success mb-2 send_test_mail">{{ __('Send Test Mail') }}</a>
							</div>
							...
							<div class="tab-pane fade" id="other" role="tabpanel" aria-labelledby="profile-tab4">
								<div class="">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="custom-select mr-sm-2" name="APP_TIMEZONE" id="APP_TIMEZONE" >
                        ...
                        <form method="post" action="{{ route('store_test_mail') }}"
                        class="basicform">
                        @csrf
								<button class="d-none" id="send_test_mail" type="submit">{{ __('Test Mail') }}</button>
                        </form>
						</div>
					</div>
				</div>
...
(function ($) {
	...
	$('#APP_TIMEZONE').val('{{ env('APP_TIMEZONE') }}')

})(jQuery); 
$(".send_test_mail").click(function(){
    $(".send_test_mail").attr('disabled', '')
    $(".send_test_mail").html('Please Wait....')
    $("#send_test_mail").click(); 
    return false;
});
</script>
@endpush
