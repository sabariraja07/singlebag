				...
				<div class="card profile-widget">
					<div class="profile-widget-header">
						...
						<div class="profile-widget-items">
							...
							<div class="profile-widget-item">
								...
								<div class="profile-widget-item-value">{{ $info->subscription->plan_info->name ?? '' }}</div>
							</div>
							...
							<div class="profile-widget-item">
								...
								<div class="profile-widget-item-value"> @if($info->subscription->status==1) <span class="badge badge-success">{{ __('Active') }}</span>
									@elseif($info->subscription->status==0) <span class="badge badge-danger">{{ __('Trash') }}</span>
									@elseif($info->subscription->status==2) <span class="badge badge-warning">{{ __('Suspended') }}</span>
									@elseif($info->subscription->status==3) <span class="badge badge-warning">{{ __('Pending') }}</span>
									@endif</div>
							</div>
						</div>
					</div>
					<div class="profile-widget-description">
						...
						<ul class="list-group">
							...
							<li class="list-group-item">{{ __('Storage Used:') }} {{ storeStorageSize($info->id) }} / {{ $info->subscription->plan_info->storage == -1 ? __('Unlimited') : human_filesize($info->subscription->plan_info->storage ?? 0) }}</li>
