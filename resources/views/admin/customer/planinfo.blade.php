        ...
        <form class="basicform" action="{{ route('admin.customer.updateplaninfo',$domain->id) }}" method="post">
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="product_limit"   value="{{ $planinfo->product_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="storage"   value="{{ $planinfo->storage ?? -1 }}">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Customer Limit') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="customer_limit"   value="{{ $planinfo->customer_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="category_limit"   value="{{ $planinfo->category_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="location_limit"   value="{{ $planinfo->location_limit ?? -1 }}">
            </div>
          </div>
          <div class="form-group row mb-4">
            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3" >{{ __('Brand Limit') }}</label>
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="brand_limit"   value="{{ $planinfo->brand_limit ?? -1 }}">
            </div>
          </div>
          ...
          <div class="form-group row mb-4">
            ...
            <div class="col-sm-12 col-md-7">
              <input type="text" class="form-control" required="" name="variation_limit"   value="{{ $planinfo->variation_limit ?? -1 }}">
            </div>
          </div>
