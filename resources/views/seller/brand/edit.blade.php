            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form class="basicform" action="{{ route('seller.brand.update', $info->id) }}" method="post"
                                ...
                                <div class="form-group row mb-4">
                                    <label
                                        class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('Thumbnail') }}<span
                                            style="color:red;">(</span>
                                        250 x250 mm <span style="color:red;">)</span></label>
                                    <div class="col-sm-12 col-md-7">
                                ...
                                <div class="form-group row mb-4">
                                    ...
                                    <div class="col-sm-12 col-md-7">
                                        <button class="btn btn-primary basicbtn save_mobile_view" type="submit"
