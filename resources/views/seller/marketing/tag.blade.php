                        ...
                        <div class="col-12">
                            ...
                            <div class="breadcrumb-wrapper">
                                ...
                                <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Google Tag Manager') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header border-bottom">
                                <h4 class="card-title">{{ __('Google Tag Manager') }}</h4>
                            </div>
                                ...
                                <form class="basicform" enctype="multipart/form-data" action="{{ route('seller.marketing.store') }}" method="post">
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-sm-6 mb-1">
                                            <label class="col-form-label" >{{ __('Google Tag Manager Id') }}</label>
