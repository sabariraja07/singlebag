        ...
        <div class="content-header row">
            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Edit BumpAds') }}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                                    </li>
                                    <li class="breadcrumb-item"><a href="{{ url('/seller/bump-ads') }}">{{ __('Bump Ads') }}</a>
                                    </li>
                                    <li class="breadcrumb-item active">{{ __('Edit BumpAds') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">{{ __('Edit BumpAds') }}</h4>
                            </div>
                            <p style="margin-left: 21px;">{{ __('Edit_Bump _Description') }}</p>
                            <hr>
                            <div class="card-body">
                                <form class="basicform" action="{{ route('seller.bump-ads.update', $info->id) }}"
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                <label class="form-label">{{ __('Thumbnail') }}<span
                                                    style="color:red;">(</span>  550 x 220 mm <span style="color:red;">)</span></label>
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="text" name="url" required="" value="{{ $info->url ?? '' }}"
                                                class="form-control">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                        ...
                                        <div class="col-12">
                                            <button type="submit" id="submit" class="btn btn-primary me-1 basicbtn">{{ __('Update') }}</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
