        ...
        <div class="content-header row">
            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Bump Ads') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('Bump Ads') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('seller.bump-ads.edit', $row->id) }}">
                                                    <i data-feather="edit-2" class="me-50"></i><span>{{ __('Edit') }}</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('seller.bump-ads.show', $row->id) }}">
                    ...
                    <div class="table-responsive custom-table">
                        <table class="table">
                            ...
                            <tbody>
                                @foreach ($posts as $row)
                                    <tr>
                                        <td class="text-left"><img src="{{ $row->image }}" height="100"></td>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('seller.bump-ads.edit', $row->id) }}"
                                                class=" btn-warning" style="padding: 2px 4px 5px 4px;"><i
                                                    data-feather='edit'></i></a>
                                            <a href="{{ route('seller.bump-ads.show', $row->id) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">{{ __('Add New Ads') }}</h1>
                        <p>{{ __('Edit_Bump _Description') }}</p>

                    </div>
                    <hr />
                    <form class="basicform_with_reload row gy-1 pt-75" action="{{ route('seller.bump-ads.store') }}"
                        method="post">
                        @csrf
