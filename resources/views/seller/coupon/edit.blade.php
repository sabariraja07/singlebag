        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Edit Coupon') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                                </li>
                                <li class="breadcrumb-item"><a href="{{ url('/seller/coupon') }}">{{ __('Coupons') }}</a>
                                </li>
                ...
                <div class="card-body">
                    <form class="basicform" action="{{ route('seller.coupon.update', $info->id) }}" method="post">
                        ...
                        <div class="form-group row mb-4">
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="text" class="form-control" required="" name="coupon_code" value="{{ $info->code }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label
                            ...
                            <div class="col-sm-12 col-md-7">
                                <input type="date" class="form-control flatpickr-basic flatpickr-input active" required="" name="date" value="{{ date('Y-m-d', strtotime($info->expiry_date ?? now())) }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-4">
                            <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">{{ __('PERCENTAGE') }}
                                (%)</label>
                            <div class="col-sm-12 col-md-7">
                                <input type="number" class="form-control" required="" name="percent" value="{{ $info->amount }}">
                            </div>
                        </div>
                        <div class="form-group row mb-4">
                            <label
