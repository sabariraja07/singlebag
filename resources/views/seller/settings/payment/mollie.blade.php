        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Mollie Method') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('Mollie Method') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form method="post" class="basicform"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <input class="form-control" required="" value="{{ $data['api_key'] ?? '' }}" name="api_key"
                                    required="" type="text">
                            </div>
