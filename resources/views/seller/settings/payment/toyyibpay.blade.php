        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('TOYYIBPAY Method') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('TOYYIBPAY Method') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <form method="post" class="basicform"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-1">
                                <label>{{ __('User Secretkey') }}</label>
                                <input class="form-control" required="" value="{{ $data['user_secretkey'] ?? '' }}"
                                    name="user_secretkey" required="" type="text">
                            </div>

                            <div class="form-group mb-1">
                                <label>{{ __('Category Code') }}</label>
                                <input class="form-control" required="" value="{{ $data['category_code'] ?? '' }}"
                                    name="category_code" required="" type="text">
                            </div>
                            {{-- <div class="form-group mb-1">
                            ...
                            <div class="form-group mb-1">
                                <div class="custom-control custom-switch">
                                    ...
                                    <small class="form-text text-muted">Test your {{ $info->name }} setup by simulating
                                        ...
                                        <small class="form-text text-muted">{{ __('Test mode (Developer only)Test your TOYYIBPAY setup by simulating successful and failed transactions.') }}</small>
