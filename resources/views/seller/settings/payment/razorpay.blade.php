        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Razorpay Method') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('Razorpay Method') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                ...
                <div class="card-body">
                    <form method="post" class="basicform"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-1">
                                <label>{{ __('key_id') }}</label>
                                <input class="form-control" required="" value="{{ $data['key_id'] ?? '' }}" name="key_id"
                                    required="" type="text">
                            </div>

                            <div class="form-group mb-1">
                                <label>{{ __('Secret Key') }}</label>
                                <input class="form-control" required="" value="{{ $data['key_secret'] ?? '' }}"
                                    name="key_secret" required="" type="text">
                            </div>
                            ...
                            {{-- <div class="form-group mb-1">
                                ...
                                <input class="form-control" required="" value="{{ $currency->code ?? "" }}" name="currency" required="" type="text">
                            </div> --}}
