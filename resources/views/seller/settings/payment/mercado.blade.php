        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Mercado Method') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('Mercado Method') }}
                                </li>
                            </ol>
                        </div>
                    </div>
                    ...
                    <form method="post" class="basicform"
                        ...
                        <div class="card-body">
                            ...
                            <div class="form-group mb-1">
                                ...
                                <input class="form-control" required="" value="{{ $data['access_token'] ?? '' }}"
                                    name="access_token" required="" type="text">
                            </div>
                            <div class="form-group mb-1">
                            ...
                            <div class="card-footer clearfix text-muted">
                                ...
                                <div class="float-left clear-both">
                                    <a class="btn btn-white"
                                        href="{{ route('seller.settings.show', 'payment') }}">Cancel</a>
