               ...
               @endif
                ...
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Terms & Conditions Generator') }}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Terms & Conditions Generator') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <hr>
                                <div class="card-body">
                                    <form id="basicform" action="{{ route('seller.terms-generator.store') }}" method="post">
                                        @csrf
