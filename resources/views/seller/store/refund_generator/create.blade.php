...
@section('title', 'Return/Refund Policy Generator')
@section('page-style')
<style>
    hr {
            width: 93% !important;
               ...
               @endif
                ...
                <div class="content-header-left col-md-12 col-12 mb-2">
                    <div class="row breadcrumbs-top">
                        <div class="col-12">
                            <h2 class="content-header-title float-start mb-0">{{ __('Return/Refund Policy Generator') }}</h2>
                            <div class="breadcrumb-wrapper">
                                <ol class="breadcrumb">
                                    ...
                                    <li class="breadcrumb-item active">{{ __('Return/Refund Policy Generator') }}
                                    </li>
                                </ol>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card">
                                ...
                                <hr>
                                <div class="card-body">
                                    <form id="basicform" action="{{ route('seller.refund-generator.store') }}" method="post">
                                        @csrf
