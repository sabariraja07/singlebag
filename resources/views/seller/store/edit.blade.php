        ...
        <div class="content-header row">
            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Edit Slider') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                                </li>
                                <li class="breadcrumb-item"><a
                                        href="{{ url('/seller/setting/slider') }}">{{ __('Sliders') }}</a>
                                </li>
                                <li class="breadcrumb-item active">{{ __('Edit Slider') }}
                                </li>
                            </ol>
                        </div>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <p class="" style="margin-left: 21px;">{{ __('Create_Slider _Description') }}</p>
                            <hr>
                            <div class="card-body">
                                <form class="basicform" action="{{ route('seller.slider.update', $info->id) }}"
                                        ...
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
                                                ...
                                                <input type="file" class="form-control" accept="Image/*" name="file"
                                                    id="file" >
                                                    @if (strpos($info->image, 'default.png') === false)
                                                        {{ substr($info->image, strrpos($info->image, '/') + 1) }}
                                                    @endif
                                                <span id="file_error"></span>
                                                <br><img src="{{ $info->image }}" alt="" srcset="" width=80 height=40 onerror="this.onerror=null; this.remove();">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-12">
                                            <div class="mb-1">
