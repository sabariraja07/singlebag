    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
            ...
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">{{ __('Slider') }}</h2>
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active">{{ __('Slider') }}
                                </li>
                            </ol>
                        </div>
                    </div>
        ...
        <div class="content-body">
            ...
            <div class="d-flex justify-content-end">
                <a href="javascript:void(0)" data-bs-target="#addslider" data-bs-toggle="modal">
                                        ...
                                        <ul class="dropdown-menu" aria-labelledby="dropdownMenuButton1">
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('seller.slider.edit', $row->id) }}">
                                                    <i data-feather="edit-2" class="me-50"></i><span>{{ __('Edit') }}</span>
                                                </a>
                                            </li>
                                            <li>
                                                <a class="dropdown-item d-flex align-items-center"
                                                    href="{{ route('seller.slider.show', $row->id) }}">
                        ...
                        <table class="table">
                            <thead>
                                <tr>
                                    ...
                                    {{-- <th class="am-title">{{ __('Text Color') }}</th> --}}
                            ...
                            <tbody>
                                @foreach ($posts as $row)
                                    <tr>
                                        ...
                                        <td class="text-right">
                                            <a href="{{ route('seller.slider.edit', $row->id) }}" class=" btn-warning"
                                                style="padding: 2px 4px 5px 4px;"><i data-feather='edit'></i></a>
                                            <a href="{{ route('seller.slider.show', $row->id) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body pb-5 px-sm-5 pt-50">
                    <div class="text-center mb-2">
                        <h1 class="mb-1">{{ __('Create Slider') }}</h1>
                        <p>{{ __('Create_Slider _Description') }}</p>

                    </div>
                    <hr />
                    <form class="basicform_with_reload row gy-1 pt-75" action="{{ route('seller.slider.store') }}"
                        method="post">
                        @csrf
