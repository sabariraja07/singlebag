...
@endif
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">{{ __('Create Variation') }}</h2>
                <div class="breadcrumb-wrapper">
                    <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                        </li>
                        <li class="breadcrumb-item"><a href="{{ route('seller.attribute.show',$info->id) }}">{{ __('VARIATIONS') }}</a>
                        </li>
                        <li class="breadcrumb-item active">{{ __('Create Variation') }}
                        </li>
                    </ol>
                </div>
            </div>
 ...
 <div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        <form class="basicform" action="{{ route('seller.attribute-term.store') }}" method="post">
          @csrf
