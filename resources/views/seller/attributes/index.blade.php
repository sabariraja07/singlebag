...
<div class="content-wrapper container-xxl p-0">
    <div class="content-header row">
        <div class="content-header-left col-md-9 col-12 mb-2">
            <div class="row breadcrumbs-top">
                <div class="col-12">
                    <h2 class="content-header-title float-start mb-0">{{ __('Attributes') }}</h2>
                    <div class="breadcrumb-wrapper">
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="{{ url('/seller/dashboard') }}">{{ __('Home') }}</a>
                            </li>
                            <li class="breadcrumb-item active">{{ __('All Attributes') }}
                            </li>
                        </ol>
                    </div>
                </div>
    ...
    <div class="content-body">
        <div class="d-flex flex-row justify-content-end">
            <div class="mt-1">
                <a href="{{ route('seller.attribute.create') }}" style=" float: right; ">
                        ...
                        <table class="table" id="pagenate" style=" table-layout: fixed; ">
                            <thead>
                                <tr>
                                    ...
                                    <th>{{ __('Name') }}</th>
                                    <th width="15%">{{ __('VARIATIONS') }}</th>
                                    <th width="15%">{{ __('Products') }}</th>
                                    {{-- @if (current_shop_type() != 'supplier')
                                        <th>{{ __('Featured') }}</th>
                                    @endif --}}
                                    <th>{{ __('Status') }}</th>
                            ...
                            <tbody>
                                @foreach ($posts as $row)
                                    <tr id="row{{ $row->id }}">
                                        ...
                                        <td>{{ $row->featured_with_product_count[0]->products_count ?? ''}}</td>
                                            {{-- @if (current_shop_type() != 'supplier')
                                                <td>
                                                    @if ($row->featured == 1)
                                                        <span
