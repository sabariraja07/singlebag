...
<div class="row justify-content-center">
	...
	<div class="col-12 col-md-4 col-lg-4">
		<div class="pricing @if($row->featured==1) pricing-highlight @endif">
			...
			<a href="{{ route('partner.make_payment',[$row->id, 'shop_id=' . $shop->id]) }}">{{ __('Subscribe') }} <i class="fas fa-arrow-right"></i></a>
			</div>
		</div>
	</div>
	@endforeach	
	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body">
				<form method="post" action="{{ route('partner.order.store') }}" id="productform">
					@csrf
