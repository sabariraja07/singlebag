                    ...
                    <div class="container">
                        ...
                        <div class="columns">
                            <div class="column is-8 is-offset-2" id="partner-form">
                                ...
                                <!-- otp up form -->
                                <form class="basicform" method="post" action="{{ route('partner.otp_verify') }}">
                                    @csrf
                                    <div id="signup-form" class="login-form animated preFadeInLeft fadeInLeft">
                                        <div class="field pb-10">
                                            <div class="control has-icons-right required">
                                                <input class="input is-medium has-shadow" type="text" name="otp_verify" id="otp_verify"
                                        ...
                                        <p style="color: red;
                                            ...
                                            <a href="{{ route('partner.resend_partner_otp',$user->id) }}" target="_self">
                                                <span id="partner_resend_otp">{{ __('Resend OTP') }}</span></a></p>
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.redirect == true) {
                            Sweet('success', '{{ __('Partner Account Created.') }}');
