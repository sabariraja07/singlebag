@extends('layouts.app')
@section('head')
@include('layouts.partials.headersection',['title'=> trans('Customer Plan Data')])
@endsection
@section('content')
<div class="row">
  <div class="col-12">
    <div class="card">
      ...
      <div class="card-body">
        ...
        <form class="basicform" action="{{ route('partner.shop.updateplaninfo',$info->id) }}" method="post">
          @csrf
          @method('PUT')
