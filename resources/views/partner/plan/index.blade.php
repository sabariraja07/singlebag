	...
	<div class="col-12 col-md-4 col-lg-4">
		<div class="pricing @if($row->featured==1) pricing-highlight @endif">
			...
			<div class="pricing-cta">
				...
				@else
				<a href="{{ route('partner.make_payment',$row->id) }}">{{ __('Subscribe') }} <i class="fas fa-arrow-right"></i></a>
				@endif
			</div>
		</div>
	</div>
...
<div class="card">
	...
	<div class="card-body">
		@php
		$posts=\App\Models\Subscription::with('plan','category')->where('shop_id',current_shop_id())->where('amount','>',0)->latest()->paginate(20);
		@endphp
			...
			<table class="table table-hover table-nowrap card-table text-center">
				...
				<tbody class="list font-size-base rowlink" data-link="row">
					...
					<tr>
						...
						<td>{{ amount_admin_format($row->amount) }}</td>
						<td>{{ amount_admin_format($row->tax) }}</td>
