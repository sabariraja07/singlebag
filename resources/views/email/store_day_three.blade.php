                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                <a href="{{ config('app.url') }}" class="f-fallback email-masthead_name">
                                    <img src="{{ asset('/frontend/singlebag/imgs/shop/store-9.png') }}"
                                        class="img-source" style="margin-bottom: 30px !important;">
        ...
        <tr class="bg-padding">
            <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                <table class="email-body_inner" id="gmail" align="center" width="570" cellpadding="0"
                    ...
                    <tr align="center">
                        <td>
                            <h1 style="text-align: center;margin-top: 10px;">Start an effective
                                Online business</h1>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        <td class="content-cell">
                            <div class="f-fallback">
                                ...
                                <h1 style="text-align: center;color: #333333;">Start adding products to your store.</h1>
                                <p style="text-align: center;">Adding and editing products is simple from the “All
                                    Products” section in your admin panel.
                                </p>

                                <p style="text-align: center;"><a href="https://youtu.be/BP_aa32iPa0"
                                        class="entroll_button">Learn how to add products</a></p>
                            </div>
                        </td>
                    </tr>
                </table>
                    ...
                    <tr>
                        <td class="content-cell">
                            <div class="f-fallback">
                                ...
                                <h1 style="text-align: center;color: #333333;">Sell in person with Singlebag POS</h1>
                                <p style="text-align: center;">Also easily sell your products in offline store, offline
                                    events, or anywhere with the free Singlebag POS app
                                </p>

                                <p style="text-align: center;"><a
                                        href="https://play.google.com/store/apps/details?id=com.singlebag.pos"
                                        class="entroll_button">Install Now</a></p>
                            </div>
                        </td>
                    </tr>
                    <tr>
