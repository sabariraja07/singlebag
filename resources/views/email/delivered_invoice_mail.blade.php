                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Greetings from {{ $get_shop_name->name ?? '' }},</h1>
                                            <p>Your order {{ $order->order_no }} is delivered on time! Rate this timely
                                                delivery here</p>
                                            {{-- <table>
                                             <tr>
                                                <td>
                                                ...
                                                <td>
                                                  Product: {{ $orderitem->term->title, }}<br>
                                                </td>
                                                @endforeach
                                             </tr>
                                            </table> --}}
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <h2 style="text-align: center;font-size: 24px;">Your Order Summary</h2>
                                                <tr>
                                                    <td>
                                                ...
                                                <tr>
                                                        ...
                                                        <td>
                                                            <h3 class="align-right">Order delivered by :
                                                                {{ $order->agent_details->first_name ?? '' }}</h3>
                                                        </td>
                                                        @endif
                                                </tr>
                                                @php
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h2 class="align-right">Delivery To</h2>
                                                        @if (!empty($location))
                                                            <p class="align-right">
                                            ...
                                            <table class="purchase" width="100%" style="margin-top: -87px;"
                                    ...
                                    <td class="content-cell" align="center">
                                        @if (!empty($location))
                                            <p class="f-fallback sub align-center">Our mailing address is: <span>
                                                    <a href="mailto: {{ $get_shop_name->email }} ">
                                                        {{ $get_shop_name->email }}</a>
                                                </span>
                                            </p>

                                            <p class="f-fallback sub align-center" style="color: black;">&copy;
                                                {{ date('Y') }}
                                                {{ $get_shop_name->name }}. All rights reserved</p>
                                        @endif
                                    </td>
                                </tr>
                            </table>
