                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <h1 style="text-align: center;color: #333333;">Get started with a free
                                                online course</h1>
                                            <p style="text-align: center;">Looking for a guided tour of Singlebag?<br>
                                            </p>
                                            <p style="text-align: center;">Join Singlebag Academy and take this free
                                                online course at<br><span style="text-align: center">your own
                                                    place.</span></p>
                                            <p style="text-align: center;"><a
                                                    href="https://community.singlebag.com/lp-courses/"
                                                    class="login_button">Enroll for free</a></p>
                                        </div>
                                    </td>
                                </tr>
                            </table>
                            ...
                            <table class="email-body_inner" id="gmail" align="center" width="570" cellpadding="0"
                                ...
                                <tr align="center" width="570" cellpadding="0" cellspacing="0" role="presentation">
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <a href="{{ config('app.url') }}" class="f-fallback email-masthead_name">
                                                <img src="{{ asset('/frontend/singlebag/imgs/shop/store-3.jpg') }}"
                                                    class="img-source1">
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <h1 style="text-align: center;color: #333333;">Get started with these free
                                                courses</h1>
                                            <p style="text-align: center;">These courses are free and will help you
                                                find, communicate,<br><span style="text-align: center">and sell to
                                                    customers.</span></p>
                                            <div>
                                                <ul class="ul-list" style="font-weight: bold;">
                                                    <li> Singlebag Certified Ecommerce Professional</li>
                                                    <li> Singlebag Certified Store Manager</li>
                                                    <li> Singlebag Certified Ecommerce Expert</li>
                                                    <li> Singlebag Certified Partner</li>
                                                </ul>
                                            </div>
