                    ...
                    <tr>
                        <td class="email-masthead">
                            <a href="{{ env('APP_URL') }}" class="f-fallback email-masthead_name">
                                <img src="{{ admin_logo_url() }}" class="img_logo" height="50" width="200">
                            </a>
                        </td>
                        {{-- <td class="email-masthead">
                            <a href="{{ url($base_url) }}" class="f-fallback email-masthead_name">
                                <img src="{{ get_shop_logo_url($info->shop_id) }}" class="img_logo"
                                    height="50" width="200">
                            </a>
                        </td> --}}
                    </tr>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <h3 class="align-right">
                                                            {{ $info->created_at->format('Y-m-d') }}</h3>
                                                    </td>
                                                </tr>
                                                        ...
                                                        <table class="purchase_content" width="100%" cellpadding="0"
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="align-right">
                                                                    {{ number_format(($info->amount ?? 0) + ($info->discount ?? 0) - $info->tax, 2) }}
                                                                </td>
                                                            </tr>
                                                            <tr>
                                                                <td>Tax</td>
                                                                <td class="align-right">
                                                                    {{ number_format($info->tax, 2) }}</td>
                                                            </tr>
                                                            <td>Discount</td>
                                                            <td class="align-right">
                                                ...
                                                <tr>
                                                    ...
                                                    <td width="20%" class="purchase_footer" valign="middle">
                                                        <p class="f-fallback purchase_total">
                                                            {{ number_format($info->amount - $info->discount + $info->tax, 2) }}
                                                        </p>
                                                    </td>
                                                </tr>
                                            </table>
                                                            ...
                                                            <tr>
                                                                <td align="left">
                                                                    <table role="presentation" border="0"
                                                                        ...
                                                                        <tbody>
                                                                            <tr>
                                                                                <td> <a href="{{ url(env('APP_URL') . '/admin/order/' . $info->id . '/edit') }}"
