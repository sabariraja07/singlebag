                    ...
                    <tr>
                        @if (file_exists($image))
                            <td class="email-masthead">
                                ...
                                <a href="{{ url('/partner/login') }}" class="login_button">Login</a>
                            </td>
                        @else
                            <td>
                                <h4
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            ...
                                            <p>You are receiving this email because your partner account has been
                                                approved successfully.</p>

                                            <hr>

                                            <p>For any queries, please contact our technical team
                                                <a href="mailto:support@singlebag.com">support@singlebag.com</a>
                                            </p>
