    ...
    <table class="email-wrapper" width="100%" cellpadding="0" cellspacing="0" role="presentation">
        <tr>
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1 style="text-align:center">Hi {{ $order_content->name ?? '' }},</h1>
                                            <!-- Action -->
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                                            ...
                                            <hr>
                                            <p style="text-align: center">Thank you for your order! <span
                                                    style="font-weight:bold">{{ $get_shop_name->name }}</span></p><br>
                                            @if (!empty($location))
                                                <p>Cheers,
                                                    <br>{{ $get_shop_name->name }},
                                                    {{ $location->address }},
