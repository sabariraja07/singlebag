                    ...
                    <tr>
                        <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                <a href="{{ config('app.url') }}" class="f-fallback email-masthead_name">
                                    <img src="{{ asset('/frontend/singlebag/imgs/shop/store-4.jpg') }}" class="img-source">
                                ...
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        <h1 style="text-align: center;margin-top: 12px;">
                                            <span style="color: #333333;">{{ $shop_name }}</span> has so much
                                            potential
                                        </h1>
                                        <h4 style="color: #212060;" align="center">Continue the progress!</h4>
                                        <p style="text-align: center;color: #212060;">Choose a plan, then work slowly to
                                            set up your store
                                            <br><span style="text-align: center">according to that. You feel stuck.
                                                Check out our setup </span>
                                            <br><span style="text-align: center">guide, which details every step you
                                                need to do to get your </span>
                                            <br><span style="text-align: center">store up and running</span>
