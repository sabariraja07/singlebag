                        ...
                        @if (file_exists($image))
                            <td class="email-masthead">
                                <a href="{{ url($base_url) }}" class="f-fallback email-masthead_name">
                                    <img src="{{ get_shop_logo_url($order->shop_id) }}" class="img_logo"
                                        height="50" width="200">
                                </a>
                            </td>
                        @else
                                ...
                                <tr>
                                    <td class="content-cell">
                                        <div class="f-fallback">
                                            <h1>Hi {{ $order_content->name ?? '' }},</h1>
                                            @if (!empty($location))
                                                <p>{{ $location->invoice_description ?? '' }}</p>
                                            @endif
                                            <!-- Action -->
                                            ...
                                            <table class="purchase" width="100%" cellpadding="0" cellspacing="0">
                                                ...
                                                <tr>
                                                    <td>
                                                        <h3>Payment status : @if ($order->payment_status == 2)
                                                                Pending
                                                    ...
                                                    <td>
                                                        <h3 class="align-right">Order Status :
                                                            {{ ucfirst(str_replace('-', ' ', $order->status)) }}</h3>
                                                    </td>

                                                </tr>
                                                @php
                                                    $gst = \App\Models\ShopOption::where('key', 'gst')
                                                ...
                                                @if (isset($gst))
                                                    <tr>
                                                        ...
                                                        @if (isset($gst))
                                                            <td>
                                                                <h3 class="align-right">GST : {{ $gst->value }}</h3>
                                                            </td>
                                                        @endif
                                                    </tr>
                                                @endif
                                            ...
                                            @foreach ($order->files as $key => $product_url)
                                                @foreach ($product_url->file ?? [] as $file)
                                                    <p style="font-size: 15px;color: black;">Product Link <span><a
                                                                href="{{ $file->url }}"
                                                                target="_blank">{{ $file->url }}</a></span></p>
                                                @endforeach
                                            @endforeach
                                            @if (!empty($location))
                                                <p>Cheers,
                                                    <br>{{ $location->company_name }}
                                                </p>
                                            @endif
                                            <!-- Sub copy -->
                                            <table class="body-sub" role="presentation">
                                                <tr>
                                                    <td>
                                                        <p class="f-fallback sub">Thank you for your order</p>
                                    ...
                                    <td class="content-cell" align="center">
                                        @if (!empty($location))
                                            <p class="f-fallback sub align-center">&copy; {{ date('Y') }}
                                                {{ $location->company_name }}. All rights reserved.</p>
                                            <p class="f-fallback sub align-center">
                                                {{ $location->company_name }}
                                                {{ $location->zip_code }}, {{ $location->address }} <br>
                                                {{ $location->city }},
                                            </p>
                                        @endif
                                    </td>
