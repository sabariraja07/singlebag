                    ...
                    <tr>
                        <td class="email-body" width="100%" cellpadding="0" cellspacing="0" style="text-align: center">
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                <a href="{{ config('app.url') }}" class="f-fallback email-masthead_name">
                                    <img src="{{ asset('/frontend/singlebag/imgs/shop/store-19.jpg') }}"
                                        class="img-source">
                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        <h1 style="color: #333333;text-align: center;margin-top: 12px;">Your store is
                                            just put on hold.
                                            Pick up a plan today and show the world what you have to offer.
                                        </h1>


                                        <p style="text-align: center;">Singlebag offers plans with same features. We
                                            can’t wait to see what’s in your store.</p>
                                        <p style="text-align: center;"><a href="https://singlebag.com/pricing/"
                                                class="login_button1" target="_blank">Start Selling Today</a></p>
            ...
            <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                <table class="email-body_inner" id="gmail" align="center" width="570" cellpadding="0"
                    ...
                    <tr align="center">
                        <td>
                            <a href="{{ config('app.url') }}" class="f-fallback email-masthead_name">
                                <img src="{{ asset('/frontend/singlebag/imgs/shop/store-20.jpg') }}" class="img-source1" style="height: 10% !important;width: 100% !important;">
                    ...
                    <tr>
                        <td class="content-cell">
                            <div class="f-fallback">
                                <h1 style="text-align: center;margin-top: 12px;">Learn how to start an Online store</h1>
                                <p style="text-align: center;color: #333333;">Watch the video below to learn about how
                                    to setup your online store, so you can set up your store without any hustle.</p>
                    ...
                    <tr>
                        <td>
                            <p style="text-align: center;"><a href="https://community.singlebag.com/lp-courses/"
                                    class="login_button1" target="_blank">Watch the video</a></p>
                        </td>
                    </tr>
                </table>
        <tr>
