                            ...
                            <table class="email-body_inner" align="center" width="570" cellpadding="0"
                                ...
                                <td class="content-cell">
                                    <div class="f-fallback">
                                        ...
                                        <h1 style="text-align: center;">The power of Singlebag</h1>

                                        <p style="text-align: center;">Sell in physical store, online, and anywhere with
                                            Singlebag.
                                            With Singlebag, you can increase sales across your entire business.</p>
        ...
        <tr>
            <td class="email-body" width="100%" cellpadding="0" cellspacing="0">
                <table class="email-body_inner" align="center" width="570" cellpadding="0" cellspacing="0"
                    role="presentation" style="background:#F4F4F7;margin-bottom: 24px;">
                    <!-- Body content -->
                    ...
                    <tr>
                        <td class="content-cell">
                            <div class="f-fallback">
                                ...
                                <h1 style="text-align: center;color: #333333;">One dashboard</h1>
                                <p style="text-align: center;">Think of it as one center, where you manage products,
                                    payments,
                                    orders, and customers across all-in-one place. Your place.</p>
                    ...
                    <tr>
                        <td class="content-cell">
                            <div class="f-fallback">
                                ...
                                <h1 style="text-align: center;color: #333333;">Endless ways to customize</h1>
                                <p style="text-align: center;">Extend the functionality of your website, POS, or back
                                    office with fully integrated apps.
                                    From customer data to Themes, pages, sliders, Ads, Payment methods, Shop
                                    details,Custom JS and CSS, PWA etc.</p>
