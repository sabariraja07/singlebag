...
export default {
    components: { StarRating , RelatedProductCard},
    ...
    methods: {
        ...
        updatePrice: function(){
            var price = $('.regular-price').data('price') ?? 0;
            var regular_price = $('.regular-price').data('regular-price') ?? 0;
            var new_price = price;
            ...
            if($('.offer-price').length != 0){
                ...
                $('.offer-price').html( this.$formatPrice(saved_price) + ' % Off');
                $('.old-price').html('<del>' +   this.$formatPrice(regular_price) + '</del>');
            }
            
            $('.regular-price').html(this.$formatPrice(new_price));
        },
