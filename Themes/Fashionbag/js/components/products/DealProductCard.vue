    ...
    <div class="product-cart-wrap style-2 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="product-img-action-wrap">
            <div class="product-img">
                <a :href="productUrl">
                    <img v-if="productImgUrl != null" :src="productImgUrl" @error="$event.target.src='/assets/img/empty/450x600.jpg'" alt="" />
                    <img v-else :src="'/assets/img/empty/450x600.jpg'" alt="" />
                </a>
            </div>
        </div>
                ...
                <div class="product-card-bottom">
                    ...
                    <div class="add-cart">
                        <a class="add" @click="addToCart" v-if="addingToCart">
                            <i class="fa fa-spinner fa-spin mr-5"></i> {{ $trans('Add') }}
                        </a>
