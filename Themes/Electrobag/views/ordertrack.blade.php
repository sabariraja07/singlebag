...
<div class="contact-us-area pt-160 pb-160">
	<div class="container">
        ...
        @if($orders)
        <div class="root">
          <h4 style="line-height: unset;font-size: 20px;">Tracking Details</h4><br>
          <h4 style="font-size: 20px;">{{$orders->order_no}}</h4>
            <div class="order-track">
              <div class="order-track-step">
                ...
                <div class="order-track-text">
                  ...
                  <span class="order-track-text-sub">{{$orders->created_at->format('d-m-Y')}}</span>
                </div>
              </div>
              <div class="order-track-step">
                <div class="order-track-status">
              ...
              <div class="order-track-step">
                ...
                <div class="order-track-text">
                  ...
                  <span class="order-track-text-sub">{{Carbon\Carbon::parse($orders->estimated_delivery_date)->format('d-m-Y')}}</span>
                </div>
              </div>
              @endif
            </div>
