...
class QRGeneratorController extends Controller
{
    ...
    {       
        return view('business_tools.qr_generator.create');
    }
    ...
    if($company_information->save())
      {
        ...
        return response()->json(['redirect' => route('qr-generator.show', $company_information->id),'message' => 'Your custom QR code has been successfully created ....!!!']);
      }
      else {
