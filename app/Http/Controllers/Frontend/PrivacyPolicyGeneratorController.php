...
class PrivacyPolicyGeneratorController extends Controller
{
    ...
    {       
        return view('business_tools.privacy_policy_generator.create');
    }
    ...
    if($company_information->save())
      {
        ...
        return redirect()->route('privacy-policy-generator.show', $company_information->id);
      }
      else {
    ...
    public function show($id)
    {
       ...
       return view('business_tools.privacy_policy_generator.show', compact('company_info'));
