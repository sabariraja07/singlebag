...
class RefundGeneratorController extends Controller
{
    ...
    {       
        return view('business_tools.refund_generator.create');
    }
    ...
    if($company_information->save())
      {
        ...
        return redirect()->route('refund-generator.show', $company_information->id);
      }
      else {
    ...
    public function show($id)
    {
       ...
       return view('business_tools.refund_generator.show', compact('company_info'));
