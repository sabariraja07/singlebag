...
class TermsGeneratorController extends Controller
{
    ...
    {       
        return view('seller.store.terms_generator.create');
    }
    ...
    if($company_information->save())
      {
        ...
        return redirect()->route('seller.terms-generator.show', $company_information->id);
      }
      else {
    ...
    public function show($id)
    {
       ...
       return view('seller.store.terms_generator.show', compact('company_info'));
