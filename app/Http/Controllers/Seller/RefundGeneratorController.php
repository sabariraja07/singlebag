...
class RefundGeneratorController extends Controller
{
    /**
    ...
    {       
        return view('seller.store.refund_generator.create');
    }
    ...
    if($company_information->save())
      {
        Session::flash('success', trans('Your custom Return/Refund Policy has been successfully generated ....!!!'));
        return redirect()->route('seller.refund-generator.show', $company_information->id);
      }
      else {
    ...
    public function show($id)
    {
       ...
       return view('seller.store.refund_generator.show', compact('company_info'));
