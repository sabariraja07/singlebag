...
class PickedUpOrderMail extends Mailable
{
    ...
    public function build()
    {
        ...
        return $this->from($user_mail->email ?? env('MAIL_TO'))
                    ->subject('Order Picked-Up Mail')
                    ->view('email.pickedup_invoice',compact('order','location','order_content','base_url','product_file_url','get_shop_name'))
