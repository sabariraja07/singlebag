...
//     -----------------------------------*/
//     if ($('.product-slider-active-1').length > 0 ) {
...
//     -----------------------------------*/
//     if ($('.product-slider-active-2').length > 0 ) {
...
//     -----------------------------------*/
//     if ($('.product-slider-active-3').length > 0 ) {
...
//     -----------------------------------*/
//     if ($('.product-slider-active-4').length > 0 ) {
...
//         Brand logo active
//     -----------------------------------*/
//     if ($('.brand-logo-active').length && $('.brand-logo-active-2').length > 0 ) {
...
//         Brand logo active 3
//     -----------------------------------*/
//     if ($('.brand-logo-active-3').length > 0 ) {
...
//     });
    ...
    //     Cart active
    // -----------------------------------*/
    // if ($('.pro-details-action').length > 0 ) {
    //     var $body = $('body'),
    ...
    if ($(".sort-by-product-area").length > 0 ) {
        var $body = $("body"),
